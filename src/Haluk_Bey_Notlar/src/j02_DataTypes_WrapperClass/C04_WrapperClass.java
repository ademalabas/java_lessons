package Haluk_Bey_Notlar.src.j02_DataTypes_WrapperClass;
...
public class C04_WrapperClass {
    ...
    public static void main(String[] args) {
        ...
        //BENIM_DOSYALAR.j01_Variables.j09_SwitchStatement.TASK id ve tc String değerlernin toplamını print eden code yazınız
        String tc = "1234455";
        String id = "98765";
        ...
        // BENIM_DOSYALAR.j01_Variables.j09_SwitchStatement.TASK-> byte short int maximum ve minimum değerlerini print eden code yazınız
