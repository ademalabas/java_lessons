package BENIM_DOSYALAR.J33_Interface.task01;
...
public class Dikdortgen implements Sekil{
    ...
    public int cevre(int... boyut) {
        if (boyut.length==1){//varrags Test01 grilen parametre 1 tane ise kare cevre  hesapla
            return (boyut[0]*4);
    ...
    public int alan(int... boyut) {
        if (boyut.length==1){//varrags Test01 grilen parametre 1 tane ise kare alanı hesapla
