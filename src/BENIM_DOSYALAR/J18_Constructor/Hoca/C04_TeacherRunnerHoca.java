...
public class C04_TeacherRunnerHoca {
    public static void main(String[] args) {

        C04_TeacherHoca ogrt1 = new C04_TeacherHoca();//ogrt1 obj create edildi
        ogrt1.ad = "Muharrem";
        ogrt1.soyad = "Güzel";
        ogrt1.branş = "Qa";
        ogrt1.emekli = false;
        ...
        C04_TeacherHoca ogrt2 = new C04_TeacherHoca("ugur","javacan","dev",15,100000,333,false);
