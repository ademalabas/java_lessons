...
public class C01_HashSet {
    ...
    public static void main(String[] args) {
        ...
        HashSet <String>    hs =new HashSet<>();// boş bir list
        HashSet <String>    hs1 =new HashSet<>(Arrays.asList("Ercan, Yakup, Adem, Rukiye, Nur"));// eleman atamasi yapilan bir hasset
        // HashSet  print etme
        System.out.println("hs1 = " + hs1);//[Ercan, Yakup, Adem, Rukiye, Nur]
        hs1.add("Kevser");//
        System.out.println(hs1);//[Kevser, Ercan, Yakup, Adem, Rukiye, Nur]
        hs1.add("Adem");//
        System.out.println("hs1 = " + hs1);//[Adem, Kevser, Ercan, Yakup, Adem, Rukiye, Nur]
