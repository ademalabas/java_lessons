...
public class C01_Abstract {
    ...
    Bu gibi durumlarda parent class2daki method'Test01 body tanımlamak ram ve memoey acısından gereksizdir.
    Çözüm olarak java Parent Class'Test01 body'siz -> abstract(soyut)  methodlar tanımlamıştır
