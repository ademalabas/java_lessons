...
/*
        ...
        byte b1 = 15;
        byte b2 =10;
        byte fark = (byte) (b1-b2);
        System.out.println(b1+b2);
        System.out.println(b1-b2);


        // Task -> iki farkli tamsayi turlerini tanimlayip toplam farkini print ediniz.
...
//Task -> tamsayı ve ondalıklı sayı tanımlayıp toplam  print ediniz
        ...
        int sayi = 63;
        char para = '$'; // 36
        System.out.println(sayi+para); // 63 + 36 = 99 $ ascii karsiligini aldi

 // Ad  ve soyadinizi prind ediniz
        String ad ="Adem";
        String soyad = "Alabas";
        int yasin = 43;
        System.out.println(ad+ "" +soyad+ ""+ yasin);
